...
public class EventService extends Service {
    ...
    private class ExecutionRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (event != null) {
                result = event.process(EventService.this, mBundle);
            }
            if (result != null) {
    ...
    public static class EventServiceCallback implements Parcelable {
        ...
        private final EventService.SpiralServiceResponder mResponder;
         ...
         */
        public EventServiceCallback(EventService.SpiralServiceResponder responder) {
            mResponder = responder;
        }
        ...
        public EventServiceCallback(Parcel parcel) {
            mResponder = (EventService.SpiralServiceResponder) parcel.readStrongBinder();
        }

        public EventService.SpiralServiceResponder getResponder() {
            return mResponder;
        }
    ...
    public static class EventServiceConnection implements ServiceConnection {
        ...
        private void sendMessage(Messenger service, Message msg) {
            try {
                ...
                Log.e(EventService.TAG, "Unable to send message to service.", e);
            }
        }
